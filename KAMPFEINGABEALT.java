...
public class KAMPFEINGABEALT implements MouseListener 
{
    ...
    public void mouseReleased(MouseEvent e) {
        if(e.getX()>458-20 && e.getX()<458+20 && e.getY()>130-20 && e.getY()<131+20) {       //heilen
            ...
            grafik.zeichneinfeld(kampf.reihenfolge[0],kampf.kepos[kampf.reihenfolge[0]],(int)kampf.leben[kampf.reihenfolge[0]]/(kampf.kaempfer.leben(kampf.reihenfolge[0]%5)));
            ...
            if(konbewegt>0) {
                ...
                grafik.markiereaktuell(kampf.kepos[kampf.reihenfolge[0]]);
                grafik.zeichneinfeld(kampf.welt[feld],feld,(int)kampf.leben[kampf.welt[feld]]/(kampf.kaempfer.leben(kampf.welt[feld]%5)));
                grafik.zeichneinfeld(kampf.welt[helpbew],helpbew,(int)kampf.leben[kampf.welt[helpbew]]/(kampf.kaempfer.leben(kampf.welt[helpbew]%5)));   
            }
            if(kampf.aktionen==0) {
                konbewegt=0;
        ...
        grafik.zeichneinfeld(kampf.welt[feld],feld,(int)kampf.leben[kampf.welt[feld]]/(kampf.kaempfer.leben(kampf.welt[feld]%5)));  //ab (int) anz
